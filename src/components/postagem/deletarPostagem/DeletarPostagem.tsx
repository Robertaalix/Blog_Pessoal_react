        ...
        <>
            <div className="container w-1/3 mx-auto">
                ...
                <p className="text-center font-semibold mb-4">
                    Você tem certeza que deseja deletar a postagem a seguir?
                </p>
                ...
                <div className="border flex flex-col rounded-2x1 overflow-hidden justify-between">
                    ...
                    <div className="p-4">
                        <p className="text-x1 h-full">{postagem.titulo}</p>
                        <p>{postagem.texto}</p>
                    </div>
                    <div className="flex">
                        <button
                            className="text-slate-100 bg-red-400 hover:bg-red-600 w-full p-2"
                            onClick={retornar}>
                            Não
                        </button>
                        <button
